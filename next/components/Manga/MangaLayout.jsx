            ...
            <div className="pt-3 lg:h-[75svh]">
                <div className="w-full h-full items-center justify-center grid grid-cols-2 ">
                    ...
                    <div className="flex-1 overflow-auto px-3 h-max lg:px-0">
                        ...
                        <p className="text-purple-500 font-light text-sm">author: {author}</p>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {genres.map((val) => (
                                <Link className="text-sm py-1 px-2 text-white bg-purple-500 hover:bg-base-300 ease-in-out duration-200 " href={"/?category=" + val}>
                                    {val}
                                </Link>
                            ))}
                        </div>
